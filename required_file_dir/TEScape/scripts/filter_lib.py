...
##this script will use cd-hit to reduce the redundant te library sequence
...
def check_double_lib_source_cd_hit (file,cdhit_exe):
    ...
    if sr_key_nm >= 2:
        ...
        cmd = cdhit_exe + " -i " + file + " -o "+ dir_nm + "/" + new_fnm + \
              ".lib -c 0.9 -G 1 -g 1 -prog blastn -circle 0 -exec local"
...
def run_cd_hit_sep (ipt_dir,cdhit_exe,lib_construction_dir):
